...
int admin_menu();
int admin();
void fiyat_gunc(float *urunler[][2]);
	...
	int admin_menu(){
		...
		scanf("%d",&sec);
			...
			switch(sec){
				...
				case 2:{
					// fiyat_gunc(float *urunler[14][2]);//fonksiyonu cagýramýyoruz
					break;		
				}
				case 3:{
...
void fiyat_gunc(float *urunler[][2]){ //ikili dizi fonksiyona gitmiyor
	printf("Lutfen seciminizi giriniz: ");
    scanf("%d",&urun_secim);
	if(urun_secim==1){
